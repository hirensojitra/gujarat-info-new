...
export class PostGenerateComponent implements OnInit, AfterViewInit {
  ...
  createTextFormGroup(t: Data): FormGroup {
    ...
    const textForm = this.fb.group({
      ...
      boxed: [t.boxed],
      text: this.fb.group({
        x: [t.text?.x ?? this.textData.text.x, Validators.required],
        y: [t.text?.y ?? this.textData.text.y, Validators.required],
        dx: [t.text?.dx ?? this.textData.text.dx, Validators.required],
        dy: [t.text?.dy ?? this.textData.text.dy, Validators.required],
        fs: [t.text?.fs ?? this.textData.text.fs, Validators.required],
        fw: [t.text?.fw ?? this.textData.text.fw, Validators.required],
        type: [t.text?.type || 'text', Validators.required],
        text: [t.text?.text ?? this.textData.text.text, Validators.required],
        color: [t.text?.color ?? this.textData.text.color, Validators.required],
        fontStyle: this.fb.group({
          italic: [t.text?.fontStyle.italic ?? this.textData.text.fontStyle.italic, Validators.required],
          underline: [t.text?.fontStyle.underline ?? this.textData.text.fontStyle.underline, Validators.required],
        }),
        rotate: [t.text?.rotate ?? this.textData.text.rotate, Validators.required],
        fontFamily: [t.text?.fontFamily ?? this.textData.text.fontFamily, Validators.required],
        textShadow: this.fb.group({
          enable: [t.text?.textShadow.enable ?? this.textData.text.textShadow.enable],
          color: [t.text?.textShadow.color ?? this.textData.text.textShadow.color],
          blur: [t.text?.textShadow.blur ?? this.textData.text.textShadow.blur],
          offsetX: [t.text?.textShadow.offsetX ?? this.textData.text.textShadow.offsetX],
          offsetY: [t.text?.textShadow.offsetY ?? this.textData.text.textShadow.offsetY],
        }),
        backgroundColor: [t.text?.backgroundColor ?? this.textData.text.backgroundColor, Validators.required],
        textEffects: this.fb.group({
          enable: [false],
          gradient: this.fb.group({
            enable: [false],
            startColor: [
              t.text?.textEffects.gradient.startColor ?? this.textData.text.textEffects.gradient.startColor,
              Validators.required,
            ],
            endColor: [
              t.text?.textEffects.gradient.endColor ?? this.textData.text.textEffects.gradient.endColor,
              Validators.required,
            ],
            direction: [
              t.text?.textEffects.gradient.direction ?? this.textData.text.textEffects.gradient.direction,
              Validators.required,
            ],
          }),
          outline: this.fb.group({
            enable: [false],
            color: [t.text?.textEffects.outline.color ?? this.textData.text.textEffects.outline.color, Validators.required],
            width: [t.text?.textEffects.outline.width ?? this.textData.text.textEffects.outline.width, Validators.required],
          }),
          glow: this.fb.group({
            enable: [false],
            color: [t.text?.textEffects.glow.color ?? this.textData.text.textEffects.glow.color, Validators.required],
            blur: [t.text?.textEffects.glow.blur ?? this.textData.text.textEffects.glow.blur, Validators.required],
          }),
        }),
        textAnchor: [t.text?.textAnchor ?? this.textData.text.textAnchor],
        alignmentBaseline: [t.text?.alignmentBaseline ?? this.textData.text.alignmentBaseline],
        letterSpacing: [t.text?.letterSpacing ?? this.textData.text.letterSpacing, Validators.required],
        lineHeight: [t.text?.lineHeight ?? this.textData.text.lineHeight, Validators.required],
        textTransformation: [t.text?.textTransformation ?? this.textData.text.textTransformation, Validators.required],
        opacity: [t.text?.opacity ?? this.textData.text.opacity, Validators.required],
        originX: [t.text?.originX ?? this.textData.text.originX],
        originY: [t.text?.originY ?? this.textData.text.originY],
        wordSpacing: [t.text?.wordSpacing ?? this.textData.text.wordSpacing, Validators.required],
        fontVariant: [t.text?.fontVariant ?? this.textData.text.fontVariant, Validators.required],
        direction: [t.text?.direction ?? this.textData.text.direction, Validators.required],
        writingMode: [
          t.text?.writingMode ?? this.textData.text.writingMode,
          Validators.required,
        ],
        textLength: [t.text?.textLength ?? this.textData.text.textLength, Validators.required],
        lengthAdjust: [t.text?.lengthAdjust ?? this.textData.text.lengthAdjust, Validators.required],
        dominantBaseline: [t.text?.dominantBaseline ?? this.textData.text.dominantBaseline, Validators.required],
        baselineShift: [t.text?.baselineShift ?? this.textData.text.baselineShift, Validators.required],
        unicodeBidi: [t.text?.unicodeBidi ?? this.textData.text.unicodeBidi, Validators.required],
        kerning: [t.text?.kerning ?? this.textData.text.kerning, Validators.required],
        whiteSpace: [t.text?.whiteSpace ?? this.textData.text.whiteSpace, Validators.required],
        fillOpacity: [t.text?.fillOpacity ?? this.textData.text.fillOpacity, Validators.required],
        stroke: [t.text?.stroke ?? this.textData.text.stroke, Validators.required],
        strokeWidth: [t.text?.strokeWidth ?? this.textData.text.strokeWidth, Validators.required],
        strokeOpacity: [t.text?.strokeOpacity ?? this.textData.text.strokeOpacity, Validators.required],
        fontSizeAdjust: [t.text?.fontSizeAdjust ?? this.textData.text.fontSizeAdjust, Validators.required],
        fontStretch: [t.text?.fontStretch ?? this.textData.text.fontStretch, Validators.required],
        visibility: [t.text?.visibility ?? this.textData.text.visibility, Validators.required],
      }),
    });
