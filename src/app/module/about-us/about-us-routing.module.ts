...
const routes: Routes = [
  {
    ...
    data: {
      title: 'Proposal for Web Application Poster Generation Service | Gujarat Info',
      ...
      keywords: 'poster generation, campaign posters, election posters, festival posts, promotional activities, customization, Gujarat Info, web application',
      robots: 'index, follow',
      'og:image': 'https://vmi2070714.contaboserver.net/api/v1/img/uploads/NyoSS/7ZiAC?quality=30',
      'og:image:alt': 'Gujarat Info Logo',
      'og:image:type': 'image/svg+xml',
      'og:image:width': '1200',
      'og:image:height': '630',
      'og:title': 'Web Application Poster Generation Service | Gujarat Info',
