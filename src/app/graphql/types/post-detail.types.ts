...
export interface CirclePropertiesInput
  extends Omit<CircleProperties, 'opacity'> {
  opacity: number;
}

export interface EllipsePropertiesInput
  extends Omit<EllipseProperties, 'opacity'> {
  opacity: number;
}
