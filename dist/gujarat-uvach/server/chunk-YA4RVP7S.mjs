...
// src/app/common/services/village.service.ts
var VillageService = class _VillageService {
  constructor(http) {
    this.http = http;
    this.apiUrl = environment.MasterApi + "/village";
  }
  /**********************************************/
  /***************** Village *******************/
  /**********************************************/
  ...
  getVillageById(village) {
    return this.http.get(`${this.apiUrl}/${village}`);
  }
  getVillageByTaluka(talukaId) {
    return this.http.get(this.apiUrl + `/taluka/${talukaId}`);
  }
  deleteVillage(id) {
  ...
  updateVillageName(villageId, villageData) {
    return this.http.put(`${this.apiUrl}/${villageId}`, villageData);
  }
  checkVillageNameAvailability(name) {
    return this.http.post(`${this.apiUrl}village-name/`, { name });
  }
  checkVillageNameAvailabilityValidator() {
    return (control) => {
      const name = control.value;
      return this.checkVillageNameAvailability(name).pipe(map((response) => response.isTaken ? { villageNameTaken: true } : null), catchError(() => of(null)));
    };
  }
  checkVillageIdAvailability(id) {
    return this.http.post(`${this.apiUrl}village-id/`, { id });
  }
  checkVillageIdAvailabilityValidator() {
    return (control) => {
      const id = control.value;
      return this.checkVillageIdAvailability(id).pipe(map((response) => response.isTaken ? { villageIdTaken: true } : null), catchError(() => of(null)));
    };
  }
  getDeletedVillageLength(districtId, talukaId) {
    return this.http.get(`${this.apiUrl}/deleted/${talukaId}`);
  }
  getDeletedVillage(talukaId) {
    return this.http.get(this.apiUrl + `/deleted-by-taluka/${talukaId}`);
  }
  toggleVillageActive(villageId) {
    return this.http.put(`${this.apiUrl}/restore/${villageId}`, {});
  }
  static {
    this.\u0275fac = function VillageService_Factory(t) {
      return new (t || _VillageService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _VillageService, factory: _VillageService.\u0275fac, providedIn: "root" });
  }
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YA4RVP7S.mjs.map
