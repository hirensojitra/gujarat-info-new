...
var routes = [
  {
    ...
    children: [
      ...
      { path: "view", loadChildren: () => import("./chunk-WGGGCKIT.mjs").then((m) => m.ViewProfileModule) },
      { path: "edit", loadChildren: () => import("./chunk-LGQLG66I.mjs").then((m) => m.EditProfileModule) }
    ]
  }
];
...
cropperjs/dist/cropper.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PNIW46KN.mjs.map
