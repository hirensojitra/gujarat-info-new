...
// src/app/module/user-profile/user-profile.component.ts
var import_cropperjs = __toESM(require_cropper());
var _c0 = ["imageInput"];
var _c1 = ["imageInputBtn"];
var _c2 = (a0) => ({ "img-thumbnail rounded-circle": a0 });
var _c3 = (a0) => ({ "me-2": a0 });
var _c4 = (a0, a1) => ({ "fa-pencil": a0, "fa-plus": a1 });
function UserProfileComponent_button_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 40);
    \u0275\u0275listener("click", function UserProfileComponent_button_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteImage());
    });
    \u0275\u0275element(1, "i", 41);
    \u0275\u0275elementEnd();
  }
...
function UserProfileComponent_ng_container_28_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Village: ", ctx_r2.village.name + " - " + ctx_r2.village.gu_name, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Taluka: ", ctx_r2.village.taluka_name + " - " + ctx_r2.village.taluka_gu_name, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("District: ", ctx_r2.village.district_name + " - " + ctx_r2.village.district_gu_name, "");
  }
}
function UserProfileComponent_button_63_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 40);
    \u0275\u0275listener("click", function UserProfileComponent_button_63_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteImage());
    });
...
var UserProfileComponent = class _UserProfileComponent {
  constructor(fb, US, DS, villageService) {
    this.fb = fb;
    this.US = US;
    this.DS = DS;
  ...
  handleImageInputChange(event) {
    ...
    if (file && (file.type === "image/jpeg" || file.type === "image/png")) {
      ...
      reader.onload = (e) => {
        ...
        this.cropper = new import_cropperjs.default(cropperElement, {
          aspectRatio: 1,
          scalable: true,
          viewMode: 1,
  ...
  saveCroppedImage() {
    ...
    if (this.profilePictureForm.valid) {
      ...
      this.US.updateUserData(this.user.id, formData).subscribe((response) => {
  ...
  base64ToFile(base64Image, fileName) {
  ...
  validateImage(username) {
    const randomParam = `?v=${(/* @__PURE__ */ new Date()).getTime()}`;
  ...
  static {
    this.\u0275fac = function UserProfileComponent_Factory(t) {
      return new (t || _UserProfileComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(DevelopmentService), \u0275\u0275directiveInject(VillageService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserProfileComponent, selectors: [["app-user-profile"]], viewQuery: function UserProfileComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(13);
        \u0275\u0275elementEnd();
        \u0275\u0275template(14, UserProfileComponent_button_14_Template, 2, 0, "button", 13);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(15, "div", 14)(16, "div", 15)(17, "div", 16)(18, "h5", 17);
        \u0275\u0275text(19);
        \u0275\u0275elementStart(20, "small", 18);
        \u0275\u0275text(21);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(27);
        \u0275\u0275elementEnd();
        \u0275\u0275template(28, UserProfileComponent_ng_container_28_Template, 7, 3, "ng-container", 20);
        \u0275\u0275elementStart(29, "input", 21, 0);
        \u0275\u0275listener("change", function UserProfileComponent_Template_input_change_29_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(34, "div", 24)(35, "div", 25)(36, "div", 26)(37, "div", 27)(38, "h5", 28);
        \u0275\u0275text(39, "Profile Photo");
        \u0275\u0275elementEnd();
        \u0275\u0275element(40, "button", 29);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "div", 30);
        \u0275\u0275element(42, "img", 31);
        \u0275\u0275elementStart(43, "form", 32);
        \u0275\u0275element(44, "input", 33)(45, "input", 34);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(46, "div", 35)(47, "button", 36);
        \u0275\u0275text(48, "Close");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(49, "button", 37);
        \u0275\u0275listener("click", function UserProfileComponent_Template_button_click_49_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.saveCroppedImage());
        });
        \u0275\u0275text(50, "Save changes");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(51, "div", 38)(52, "div", 25)(53, "div", 26)(54, "div", 27)(55, "h5", 39);
        \u0275\u0275text(56, "Profile Photo");
        \u0275\u0275elementEnd();
        \u0275\u0275element(57, "button", 29);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(58, "div", 30)(59, "div", 10)(60, "button", 11);
        \u0275\u0275listener("click", function UserProfileComponent_Template_button_click_60_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.openImageCropperDialog());
        });
        \u0275\u0275element(61, "i", 12);
        \u0275\u0275text(62);
        \u0275\u0275elementEnd();
        \u0275\u0275template(63, UserProfileComponent_button_63_Template, 2, 0, "button", 13);
        \u0275\u0275elementEnd()();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("src", ctx.imageUrl, \u0275\u0275sanitizeUrl)("ngClass", \u0275\u0275pureFunction1(18, _c2, ctx.user.image));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(20, _c3, ctx.user.image));
        \u0275\u0275advance();
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(22, _c4, ctx.user.image, !ctx.user.image));
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(ctx.user.image ? "Change\xA0Photo" : "Add\xA0Photo");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.user.image);
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1("", ctx.user.firstname + " " + ctx.user.lastname, " ");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(ctx.user.username);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("Mobile: ", ctx.user.mobile, "");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("Email: ", ctx.user.email, "");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("Roles: ", ctx.user.roles, "");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.village);
        \u0275\u0275advance(15);
        \u0275\u0275property("formGroup", ctx.profilePictureForm);
        \u0275\u0275advance(17);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(25, _c3, ctx.user.image));
        \u0275\u0275advance();
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(27, _c4, ctx.user.image, !ctx.user.image));
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(ctx.user.image ? "Change\xA0Photo" : "Add\xA0Photo");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.user.image);
      }
    }, dependencies: [NgClass, NgIf, RouterOutlet, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserProfileComponent, { className: "UserProfileComponent", filePath: "src\\app\\module\\user-profile\\user-profile.component.ts", lineNumber: 20 });
})();

// src/app/module/user-profile/user-profile-routing.module.ts
var routes = [
  {
    path: "",
    ...
    children: [
      ...
      { path: "view", loadChildren: () => import("./chunk-MVPW7SAT.js").then((m) => m.ViewProfileModule) },
      { path: "edit", loadChildren: () => import("./chunk-5HT27UPS.js").then((m) => m.EditProfileModule) }
    ]
  }
];
var UserProfileRoutingModule = class _UserProfileRoutingModule {
  static {
    this.\u0275fac = function UserProfileRoutingModule_Factory(t) {
      return new (t || _UserProfileRoutingModule)();
    };
  }
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _UserProfileRoutingModule });
  }
  static {
...
// src/app/module/user-profile/user-profile.module.ts
var UserProfileModule = class _UserProfileModule {
  ...
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _UserProfileModule });
  }
  static {
...
cropperjs/dist/cropper.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EZSB7HOC.js.map
